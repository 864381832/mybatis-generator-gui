...
public class PictureProcessStateController {
    private ImageView dbImage = new ImageView(this.getClass().getResource("/icons/SSH_tunnel.png").toExternalForm());
    ...
    public void playFailState(String message, boolean showButton) {
        ...
        dbImage.setImage(new Image(this.getClass().getResource("/icons/SSH_tunnel_disconnected.png").toExternalForm()));
    ...
    public void playSuccessState(String message, boolean showButton) {
        rect.setFill(DARKSEAGREEN);
        rotateTransition.stop();
        dbImage.setImage(new Image(this.getClass().getResource("/icons/SSH_tunnel.png").toExternalForm()));
